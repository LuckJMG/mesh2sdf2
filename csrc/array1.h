...
// For the most part std::vector operations are supported, but only valid
// when used with plain-old-data. Note: for the most part assertions are done
// with assert(), not exceptions...
